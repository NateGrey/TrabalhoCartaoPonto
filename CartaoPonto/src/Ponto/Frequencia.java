...
public class Frequencia {
	...
	public void setCartao(String cCartao) {
		if (cCartao == null) {
			throw new IllegalArgumentException(
					"O número do cartão não pode ser nulo!");
		}
	...
	public void setEntrada(Time entrada) {
		if (entrada == null) {
			throw new IllegalArgumentException(
					"A hora de entrada não pode ser nulo!");
		}
	...
	public void setIntervalo(Time intervalo) {
		/*
		 * if (intervalo == null) { throw new
		 * IllegalArgumentException("A hora do intervalo não pode ser nulo!"); }
		 */
	...
	public void setVolta(Time volta) {
		/*
		 * if (volta == null) { throw new
		 * IllegalArgumentException("A hora da volta não pode ser nulo!"); }
		 */
	...
	public void setSaida(Time saida) {
		/*
		 * if (saida == null) { throw new
		 * IllegalArgumentException("A hora da saida não pode ser nulo!"); }
		 */
	...
	public String toString() {
		return String.format(
				"\nFrequencia [cCartao=%s, dia=%s, entrada=%s, intervalo=%s,"
						+ "volta=%s, saida=%s]", cCartao, dia, entrada,
